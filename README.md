...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Models-25-blue" alt="Models">
...
<p align="center">
  <strong>LeNet-5 → AlexNet → VGG / Inception → FCN / U-Net → ResNet / ResNeXt / DenseNet → Faster R-CNN / SSD / YOLO / RetinaNet / Mask R-CNN → DeepLabV3 → DETR → MobileNet / EfficientNet → SimCLR → ViT / DeiT / Swin → ConvNeXt → Self-Supervised & Multimodal → 3D & Human-Centric Vision</strong>
</p>
...
- **Self-supervised learning:** MoCo, BYOL, DINO
