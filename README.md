...
| Model | Year | Parameters | Paper | Implementation |
|---|---:|---:|---|---|
...
| VGG-16 | 2014 | 138,357,544 | [Very Deep Convolutional Networks for Large-Scale Image Recognition](https://arxiv.org/abs/1409.4842) | [models/vgg16.py](models/vgg16.py) |
